...
it under the terms of the GNU General Public License artistService published by
 ...
 */
package com.ventura.umusic.ui.widget.external;
...
public class SelectionInfo {
	...
	/**
	 * select the {@link #getSpannable()} between the offsets {@link
	 * this.getStart()} and {@link #getEnd()}
	 */
	public void select() {
		select(mSpannable);
	}
